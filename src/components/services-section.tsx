...
export function ServicesSection() {
  return (
    <div id="services" className="grid grid-cols-1 @lg:grid-cols-12 py-16 @lg:py-24 bg-background px-6 @lg:px-0">
      ...
      <div className="col-span-1 @lg:col-start-3 @lg:col-span-4">
        <p className="text-lg @lg:text-xl mb-2 leading-relaxed text-white">
